...
function AuthUserCreation({ ...others }) {
  ...
  const [userRole, setUserRole] = useState(""); // Initialize it with an empty string or a default role
...
export default AuthUserCreation;
