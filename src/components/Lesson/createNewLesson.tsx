...
import CourseCreation from '../Cource/course-forms/couese-creation';
import LessonCreation from './lesson-forms/lesson-creation';

function CreateNerLesson
({ setShowAddLesson }: any) {
...
export default CreateNerLesson
;
