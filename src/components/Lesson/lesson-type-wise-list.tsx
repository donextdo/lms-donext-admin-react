...
function LessonTypeWiseList({ data }: any) {
    ...
    const deleteLesson = async (userId: number) => {
        try {
            ...
            openErrorDialog('Lesson deletion failed!', 'Try again');
        }
    };
                    ...
                    <Grid container spacing={1}>
                        ...
                        <IconButton
                            ...
                            onClick={() =>
                                ...
                                "Delete Confirmation",
                                `Are you sure you want to delete this lesson? Please enter 'confirm' to proceed.`,
                                { id: params.formattedValue, action: "delete" },
                                (data, values) => {
                                    if (values.comment === 'Confirm' || values.comment === 'confirm') {
                                    deleteLesson(params.row.id);
                                    }
                                }
                                )
                            }
...
export default LessonTypeWiseList;
